                          ...
                          @endif
      						<h4> >> {{ $catTitle }} >> {{ $subCatTitle }}</h4><span class="sv-bottom-line"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('model',null,['class'=>'form-control','placeholder'=>'Name of the Model']) !!}
                                </div>
                                <div class="form-group">
      								{!! Form::label('os','Operating System Name :', ['class'=>'sv-label']) !!}
      								{!! Form::text('os',null,['class'=>'form-control','placeholder'=>'Name of the Operating System']) !!}
      							</div>
      							<div class="form-group">
                                ...
                                <div class="form-group">
      								{!! Form::label('number_of_sim','Number of Sims Mobile Can Contain :', ['class'=>'sv-label']) !!}
      								{!! Form::text('number_of_sim',null,['class'=>'form-control','placeholder'=>'Number of Sims Mobile Can Contain']) !!}
      							</div>
      							<div class="form-group">
