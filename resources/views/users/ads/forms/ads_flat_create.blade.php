      				...
      				<div class="col-sm-8">
                          ...
                          @endif
      						<h4> >> {{ $catTitle }} >> {{ $subCatTitle }}</h4><span class="sv-bottom-line"></span>
      							...
      							<div class="form-group">
                                    {!! Form::label('type','Product type :', ['class'=>'sv-label']) !!}
                                    {!! Form::text('type',null,['class'=>'form-control','placeholder'=>'Product type']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('area','Area in Km^2:', ['class'=>'sv-label']) !!}
                                    {!! Form::text('area',null,['class'=>'form-control','placeholder'=>'Area in Km^2']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('bed_room','Number of Bedrooms :', ['class'=>'sv-label']) !!}
                                    {!! Form::text('bed_room',null,['class'=>'form-control','placeholder'=>'Number of Bedrooms']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('bath_room','Number of Bathrooms:', ['class'=>'sv-label']) !!}
                                    {!! Form::text('bath_room',null,['class'=>'form-control','placeholder'=>'Number of Bathrooms']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('floor','Number of Floors :', ['class'=>'sv-label']) !!}
                                    {!! Form::text('floor',null,['class'=>'form-control','placeholder'=>'Number of Floors']) !!}
                                </div>
      							<div class="form-group">
