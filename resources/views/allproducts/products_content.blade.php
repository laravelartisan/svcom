          							    ...
          							    @foreach($vvipProductsWithImage as $imageName=>$product)
          							     ...
          							     {{--{!! HTML::image('imagecache/free/'.$imageName , NULL, array('class'=>"sv-recent-leftads-l-Ads_img img-responsive")) !!}--}}
                                            ...
                                            <img u="image" src="{!! asset('imagecache/vvip/'.$imageName) !!}" />
                                                <span class="text-content"><span>{{ $product->title }}<br><a href="{{ URL::route('product.details',[ $product->id]) }}" class="btn btn-success">View -1</a></span></span>
                                          </div>
                                    ...
                                    <div class="view view-seventh">
                                     ...
                                     {{--{!! HTML::image('img/adsImg/sv-vip-Adv1-img.jpg', NULL, array('class'=>"sv-vip-Adv1-img img-responsive")) !!}--}}
                                        ...
                                        <div class="mask">
                                            ...
                                            <a href="{{ URL::route('product.details',[ $product->id]) }} " class="btn btn-info btn-status">Details</a>
                                        </div>
                                    </div>
          								...
          								@foreach($freeProductsWithImage as $imageName=>$product)
                                            ...
                                            <div class="row">
                                              <div class="col-md-12 sv-recent-leftads">
                                                  <div class="row">
                                                      <div class="col-md-9 sv-recent-leftads-l-title"><a href="{{ URL::route('product.details',[ $product->id]) }}" >{{ $product->title }} </a></div>
                                                  ...
                                                  <div class="row ">
                                                      ...
                                                      <div class="col-md-3 sv-recent-leftads-l-Ads-des">
                                                          ...
                                                          <a href="{{ URL::route('product.details',[ $product->id]) }}" class="btn btn-warning">More</a>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
